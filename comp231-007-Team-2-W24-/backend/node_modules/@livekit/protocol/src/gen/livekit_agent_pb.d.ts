 ...
 */
export declare class WorkerInfo extends Message<WorkerInfo> {
  /**
  ...
  /**
   * @generated from field: livekit.JobType type = 5;
   */
  type: JobType;

  /**
   * @generated from field: livekit.ParticipantPermission allowed_permissions = 6;
   */
  ...
  static readonly typeName = "livekit.WorkerInfo";
...
export declare class UpdateJobStatus extends Message<UpdateJobStatus> {
   ...
   *
   * @generated from field: optional livekit.JobStatus status = 2;
   */
  status?: JobStatus;
   ...
   *
   * @generated from field: float load = 5;
   */
  load: number;
