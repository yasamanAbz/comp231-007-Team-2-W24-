...
/**
 * @generated from message livekit.WorkerInfo
 */
export const WorkerInfo = /*@__PURE__*/ proto3.makeMessageType(
  "livekit.WorkerInfo",
  () => [
    ...
    { no: 5, name: "type", kind: "enum", T: proto3.getEnumType(JobType) },
    { no: 6, name: "allowed_permissions", kind: "message", T: ParticipantPermission },
  ],
);
...
export const UpdateJobStatus = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    { no: 1, name: "job_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "status", kind: "enum", T: proto3.getEnumType(JobStatus), opt: true },
    { no: 3, name: "error", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 4, name: "metadata", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
    { no: 5, name: "load", kind: "scalar", T: 2 /* ScalarType.FLOAT */ },
  ],
);
...
export const UpdateWorkerStatus = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "metadata", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
